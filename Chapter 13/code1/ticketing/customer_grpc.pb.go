...
func RegisterCustomerControllerServer(s grpc.ServiceRegistrar, srv CustomerControllerServer) {
	s.RegisterService(&CustomerController_ServiceDesc, srv)
}
...
// CustomerController_ServiceDesc is the grpc.ServiceDesc for CustomerController service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var CustomerController_ServiceDesc = grpc.ServiceDesc{
